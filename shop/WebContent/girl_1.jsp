...
<body>
	...
	<div class="content">
	<div class="back">
	<a href="cloth.jsp">返回</a>
	</div>
		<div class="left">
			<ul>
				<li><img src="img/girl_1.png">
					<div class="boy">
						<p>
							<img src="img/girl_2.png" /> <img src="img/girl_2.png" /> <img
								src="img/girl_2.png" /> <img src="img/girl_2.png" />
						</p>
					</div></li>
			</ul>
		</div>
			...
			<div class="right">
				...
				<div class="">
					...
					<br> 数量： <select name="add">
					 ...
					 <br>
					<br> <input type="submit" value=" 加入购物车" class="style3">
				</div>
