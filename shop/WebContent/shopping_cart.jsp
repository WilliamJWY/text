...
<body>
	...
	<tr>
	<td>
	用户ID</td><td><input type="text"></td>
	</tr>
	<tr>
	</tr>
	<tr>
	<td>
	商品编号</td><td><input type="text"></td>
	</tr>
	<tr>
	<td>
	商品名称</td><td><input type="text"></td>
	</tr>
	<tr>
	<td>
	商品单价</td><td><input type="text"></td>
	</tr>
	<tr>
	<td>
	商品数量</td><td><input type="text"></td>
	</tr>
	<tr>
	<td>
	商品总价</td><td><input type="text"></td>
	</tr>
	</table>
	<input type="button" value="提交" class="style">
