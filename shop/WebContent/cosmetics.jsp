...
<body>
	...
	<ul>
	<li>
	<p class="proimg"><img width="220" height="282"  src="img/31.jpg"></p>
	<p class="proprice">￥99.00</p>
	<p class="proname">泊泉雅墨菊护肤套装彩妆组合</p>
	</li>
	<li>
	<p class="proimg"><img width="220" height="282"  src="img/32.jpg"></p>
	<p class="proprice">￥108.00</p>
	<p class="proname">萃芙理 孕妇护肤品化妆彩妆</p>
	</li>
	<li>
	<p class="proimg"><img width="220" height="282"  src="img/33.jpg"></p>
	<p class="proprice">￥199.00</p>
	<p class="proname">波儿魅力女王遮瑕套装</p>
	</li>
	<li>
	<p class="proimg"><img width="220" height="282"  src="img/34.jpg"></p>
	<p class="proprice">￥158.00</p>
	<p class="proname">尊蓝 肤品化妆彩妆</p>
	</li>
	<li>
	<p class="proimg"><img width="220" height="282"  src="img/35.jpg"></p>
	<p class="proprice">￥108.00</p>
	<p class="proname">LAKOU 象牙色 替换装</p>
	</li>
	<li>
	<p class="proimg"><img width="220" height="282"  src="img/36.jpg"></p>
	<p class="proprice">￥155.00</p>
	<p class="proname">RENA 化妆品收纳盒多抽屉组合</p>
	</li>
	<li>
	<p class="proimg"><img width="220" height="282"  src="img/37.jpg"></p>
	<p class="proprice">￥79.00</p>
	<p class="proname">植色v7素颜霜50gBB霜保湿补水面霜</p>
	</li>
	<li>
	<p class="proimg"><img width="220" height="282"  src="img/38.jpg"></p>
