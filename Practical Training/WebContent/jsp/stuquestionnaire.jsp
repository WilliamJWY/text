<%@ page language="java" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8" import="com.pt.vo.Option" import="com.pt.vo.Index_c" import="java.util.*"%>
...
<s:iterator value="#session.st" var="st">
<input type="text" name="ser.sid" value="<s:property value="#st.sid"/>" hidden="">
<input type="text" name="ser.classid" value="<s:property value="#st.classid"/>" hidden="">
</s:iterator>
<% int tid=Integer.parseInt(request.getParameter("tid")); %>
<input type="text" value="<%=tid%>" name="ser.tid" hidden="">

<%
List<Index_c> listc=(List<Index_c>)session.getAttribute("ic"); //权重表

double  score=0.0;
%>

<input type="text" name="ser.qid" value="<% out.print(listc.get(0).getPid());%>" hidden="">
...
<%} %>
<input type="text" name="ser.score" id="score" hidden="">
