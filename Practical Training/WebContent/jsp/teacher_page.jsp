...
<link rel="stylesheet" id="pageloader-css" href="../css/pageloader.css"
...
<body>
	...
	<div id="bonfire-pageloader">
		<div class="bonfire-pageloader-icon">
			<svg version="1.1" xmlns="http://www.w3.org/2000/svg"
				xmlns:xlink="http://www.w3.org/1999/xlink" width="512px"
				height="512px" viewBox="0 0 512 512"
				enable-background="new 0 0 512 512" xml:space="preserve"> <path
				id="loading-12-icon"
				d="M291,82.219c0,16.568-13.432,30-30,30s-30-13.432-30-30s13.432-30,30-30S291,65.65,291,82.219z
			...
			c-14.346,8.285-19.264,26.633-10.98,40.982C155.787,135.017,174.137,139.932,188.482,131.649z"></svg>
			<span
				style="font-family: youyuan; font-size: 26px; font-weight: bold;">奋斗中!</span>
		</div>
	...
	<div id="page">
		...
		<div id="top">
			<div class="head">
				...
				<div class="head05">
					<div class="head03">
						<a href="logoff.jsp" style="text-decoration: none;">注销</a>
					</div>
	...
	$(function(){
	    setInterval("getTime()",1000);
			...
			<div id="center">
				<div id="left">
					...
					<a href="page5.jsp" target="main"
						style="text-decoration: none;"><div id="dj3">修改密码</div></a> <a
						href="peer_review.jsp" target="main"
						style="text-decoration: none;"><div id="dj4">同行评价</div></a> 
						<a
						href="tchselfquestionnaire.jsp" target="main"
						style="text-decoration: none;"><div id="dj4">自我评价</div></a>
				</div>

				<div id="right">
					<iframe name="main" src="page2.jsp" width="100%" height="100%"
						style="background-color: #FFF; background: rgba(230, 230, 230, 0.6); border-radius: 15px;"
		...
		<div id="footer">
			<p>
				<span style="font-family: youyuan; font-size: 20px;">重庆工程学院150010104班第五小组
					otaku team&nbsp;版权所有&nbsp;2016-2026&nbsp;ALL Right Reserved</span>
			</p>
		</div>
	</div>
