	    ...
	    setInterval("getTime()",1000);
			...
			<div id="center">
				<div id="left">
					...
					<a href="editspass.jsp" target="main" style="text-decoration: none;"><div
							id="dj3">修改密码</div></a> <a href="student_evaluation.jsp"
						target="main" style="text-decoration: none;"><div id="dj4">学生评价</div></a>
				</div>
