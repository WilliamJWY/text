			...
			<div id="center">
				<div id="left">
					 ...
					 <a href="page5.jsp" target="main"
						style="text-decoration: none;"><div id="dj3">修改密码</div></a> 
						<a href="view_evaluation.jsp" target="main"
						style="text-decoration: none;"><div id="dj1">查看评价</div></a> <a
						href="leadership_evaluation.jsp" target="main" style="text-decoration: none;"><div
							id="dj2">领导评价</div></a>
				</div>
