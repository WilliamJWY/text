...
<body>
	<div id="top_font">
		<span
			style="font-family: youyuan; font-size: 25px; font-weight: bold;">添加父级指标</span>
		<a href="page7.jsp"
...
指标名：</td><td><input type="text" name="ip.pname" style="border: #CCC 1px solid; width: 300px; height: 30px; font-size: 15px; font-family: youyuan; border-radius: 5px;  outline: none;"></td></tr>
<tr>
<td  style="font-family: youyuan; font-size: 20px;">
权重：</td><td><input type="text" name="ip.weight" style="border: #CCC 1px solid; width: 300px; height: 30px; font-size: 15px; font-family: youyuan; border-radius: 5px;  outline: none;"></td></tr>
<tr>
<td>
</td>
<td>
