...
<body>
	<s:form action="register" name="注册表" method="post">
		<table border="1">
			<tr>
				<td>用户名:</td><td><s:textfield name="user.username" label="用户名"></s:textfield>
				</td>
			</tr>
			<tr>

				<td>密码:</td><td><s:password name="user.pass" label="密码"></s:password></td>
			</tr>
			<tr>

				<td>性别:</td><td><s:radio list="#{'1':'男','0':'女'}" name="user.sex"
						value="1" label="性别"></s:radio></td>
			</tr>
