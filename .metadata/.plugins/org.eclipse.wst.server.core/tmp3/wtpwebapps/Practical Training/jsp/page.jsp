...
<span style="font-family:youyuan; font-size:26px; font-weight:bold;">奋斗中!</span>
	</div>
...
<script>     
	...
	$(function(){
	    setInterval("getTime()",1000);
			...
			<div id="center">
				<div id="left">
					...
					<a href="userManage.jsp" target="main"
						style="text-decoration: none;"><div id="dj1">用户管理</div></a> <a
						href="loginAdmin" target="main" style="text-decoration: none;"><div
							id="dj2">角色管理</div></a> <a href="page5.jsp" target="main"
						style="text-decoration: none;"><div id="dj3">修改密码</div></a> <a
						href="QuestionnaireSelect.jsp" target="main"
						style="text-decoration: none;"><div id="dj4">问卷管理</div></a> <a
						href="page7.jsp" target="main" style="text-decoration: none;"><div
							id="dj5">指标管理</div></a>
				</div>
		...
		<div id="footer">
			<p>
				<span style="font-family: youyuan; font-size: 20px;">重庆工程学院150010104班第五小组 otaku team&nbsp;版权所有&nbsp;2016-2026&nbsp;ALL
					Right Reserved</span>
			</p>
		</div>
	</div>
