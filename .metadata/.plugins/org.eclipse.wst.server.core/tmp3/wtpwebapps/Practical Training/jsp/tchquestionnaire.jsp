...
<form action="addTER" method="post">


<% int jobid=Integer.parseInt(request.getParameter("jobid")); %>
<input type="text" value="<%= jobid %>" name="ter.jobid" hidden="">
...
<span style="line-height:30px; font-family:youyuan; margin-left:20px;" ><%out.print(i+1); %>.<%out.print(listc.get(i).getIname()); %></span>
	...
	<div style="width:100%; height:50px; background-color:#CCC; line-height:50px; border-radius: 5px;">
		...
		<input type="radio" name="<%  out.print(op.get(j).getOid());%>" value="10" onclick="jisuan(this)"/><%  out.print(op.get(j).getA());%>
...
<input type="text" name="ter.tertype" value="同行问卷" hidden="">
