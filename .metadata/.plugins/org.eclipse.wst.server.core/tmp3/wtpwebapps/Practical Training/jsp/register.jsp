		...
		<div id="table" align="center">
			<form method="post" id="f1">
				<table border="0">
					...
					<tr>
							<td style="text-align: right;"><a href="login.jsp"
								style="font-family: youyuan; font-size: 15px; color: #7C7C7C; font-weight: bold; text-decoration: none; padding-right:10px;">已注册  返回</a>
							</td>
						</tr>
